...
class AppConstants {
  ...
  static String line1 = "We will call you or send you an SMS to confirm your number. number. You will be charged the usual fees for Nmessage and data transfer charges apply.";
  static String line2 ="Make sure that the information matches the name on your official ID document.";
  ...
  static const String loreum_ipsum = '''Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
  ''';


  static double default_radius = 7;
  static double svg_icon_size = 18;
}